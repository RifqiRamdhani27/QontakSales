...
export default function PenjualanPerProduk() {
  ...
  const [drawerUrutkan, setDrawerUrutkan] = useState("Nama produk");
  const [showDrawerUrutkanDropdown, setShowDrawerUrutkanDropdown] = useState(false);
  const drawerUrutkanRef = useRef(null);
  const [drawerUrutanOrder, setDrawerUrutanOrder] = useState("asc"); // "asc" | "desc"
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (drawerTipeRef.current && !drawerTipeRef.current.contains(event.target)) setShowDrawerTipeDropdown(false);
  ...
  const handleResetDrawer = () => {
    ...
    setDrawerTipeTransaksi("Faktur penjualan");
    setDrawerTagInput("");
            ...
            <div style={{ position: "relative", width: "260px", height: "190px", marginBottom: "20px", display: "flex", alignItems: "center", justifyContent: "center", userSelect: "none" }}>
              <svg style={{ width: "100%", height: "100%", overflow: "visible" }} fill="none" viewBox="0 0 320 230" xmlns="http://www.w3.org/2000/svg">
                <g opacity="0.95">
                  ...
                  <path d="M72 178 L160 148 L248 178 L160 208 Z" fill="url(#pedestal-gradient-penjualan-pelanggan)" />
                </g>
                <g transform="translate(68, 55)">
                  <ellipse cx="42" cy="65" fill="#fda4af" opacity="0.4" rx="38" ry="18" />
                  <path d="M8 44 C8 24 23 8 42 8 C61 8 76 24 76 44 L76 54 C76 74 61 90 42 90 C23 90 8 74 8 54 Z" fill="url(#pink-donut-depth-penjualan-pelanggan)" />
                  <ellipse cx="42" cy="44" fill="url(#pink-donut-face-penjualan-pelanggan)" rx="34" ry="34" />
                ...
                <g transform="translate(148, 92)">
                  <path d="M-8 48 C6 44 14 36 28 20 C34 14 38 4 48 -6" fill="none" stroke="url(#trend-arrow-stroke-penjualan-pelanggan)" strokeLinecap="round" strokeWidth="9" />
                ...
                <g transform="translate(216, 92)">
                  ...
                  <path d="M6 32 C6 18 17 6 30 6 C43 6 54 18 54 39 Z" fill="url(#pink-donut-depth-small-penjualan-pelanggan)" />
                  <ellipse cx="30" cy="32" fill="url(#pink-donut-face-penjualan-pelanggan)" rx="24" ry="24" />
                  <ellipse cx="30" cy="32" fill="#ffffff" rx="10" ry="10" />
                  <path d="M30 8 A24 24 0 0 1 54 32 L44 32 A14 14 0 0 0 30 18 Z" fill="#fb7185" />
                </g>
                <defs>
                  <linearGradient gradientUnits="userSpaceOnUse" id="pedestal-gradient-penjualan-pelanggan" x1="72" x2="248" y1="148" y2="208">
                    <stop stopColor="#ffffff" />
                    <stop offset="0.5" stopColor="#f8fafc" />
                    <stop offset="1" stopColor="#e2e8f0" />
                  </linearGradient>
                  <linearGradient gradientUnits="userSpaceOnUse" id="pink-donut-face-penjualan-pelanggan" x1="8" x2="76" y1="8" y2="76">
                    <stop stopColor="#fda4af" />
                    <stop offset="1" stopColor="#f43f5e" />
                  </linearGradient>
                  <linearGradient gradientUnits="userSpaceOnUse" id="pink-donut-depth-penjualan-pelanggan" x1="8" x2="76" y1="8" y2="90">
                    <stop stopColor="#f43f5e" />
                    <stop offset="1" stopColor="#be123c" />
                  </linearGradient>
                  <linearGradient gradientUnits="userSpaceOnUse" id="pink-donut-depth-small-penjualan-pelanggan" x1="6" x2="54" y1="6" y2="65">
                    <stop stopColor="#f43f5e" />
                    <stop offset="1" stopColor="#9f1239" />
                  </linearGradient>
                  <linearGradient gradientUnits="userSpaceOnUse" id="trend-arrow-stroke-penjualan-pelanggan" x1="-8" x2="48" y1="48" y2="-6">
        ...
        <div style={{ position: "fixed", inset: 0, zIndex: 99999, overflow: "hidden" }}>
          ...
          >
            ...
            <div style={{ flex: 1, overflowY: "auto", padding: "20px 24px", display: "flex", flexDirection: "column", gap: "20px" }}>
              ...
              {/* Tipe transaksi */}
              <div style={{ position: "relative" }} ref={drawerTipeRef}>
                <label style={{ display: "block", fontSize: "13px", fontWeight: 600, color: "#344054", marginBottom: "6px" }}>
                  Tipe transaksi
                </label>
                <div
                ...
                >
                  <span style={{ fontSize: "13.5px", color: "#101828" }}>{drawerTipeTransaksi}</span>
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#667085" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                    style={{ transition: "transform 0.2s ease", transform: showDrawerTipeDropdown ? "rotate(180deg)" : "rotate(0deg)" }}>
                    <path d="M6 9l6 6 6-6" />
                  </svg>
                </div>
                {showDrawerTipeDropdown && (
                  <div style={{
                    ...
                    {["Faktur penjualan", "Penagihan penjualan", "Pemesanan penjualan", "Penawaran penjualan", "Retur penjualan"].map((opt) => (
                      <div
                        key={opt}
                        onClick={() => {
                          setDrawerTipeTransaksi(opt);
                          setShowDrawerTipeDropdown(false);
                        }}
                        style={{
                          padding: "8px 14px", fontSize: "13.5px",
                          color: drawerTipeTransaksi === opt ? "#4f66ee" : "#1e293b",
                          fontWeight: drawerTipeTransaksi === opt ? 600 : 400,
                          backgroundColor: drawerTipeTransaksi === opt ? "#f1f5f9" : "transparent",
                          cursor: "pointer",
                        }}
                      >
                        {opt}
              ...
              {/* Pelanggan */}
              <div style={{ position: "relative" }} ref={drawerPelangganRef}>
                <label style={{ display: "block", fontSize: "13px", fontWeight: 600, color: "#344054", marginBottom: "6px" }}>
                  Pelanggan
                </label>
                <div
                ...
                >
                  <span style={{ fontSize: "13.5px", color: drawerPelanggan ? "#101828" : "#94a3b8" }}>
                    {drawerPelanggan || "Pilih pelanggan"}
                  </span>
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#667085" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                    style={{ transition: "transform 0.2s ease", transform: showDrawerPelangganDropdown ? "rotate(180deg)" : "rotate(0deg)" }}>
                    <path d="M6 9l6 6 6-6" />
                  </svg>
                </div>
                {showDrawerPelangganDropdown && (
                  <div style={{
                    ...
                    {["Semua Pelanggan", "PT. Maju Bersama", "CV. Abadi Jaya", "Toko Sejahtera"].map((opt) => (
                      <div
                        key={opt}
                        onClick={() => {
                          setDrawerPelanggan(opt);
                          setShowDrawerPelangganDropdown(false);
                        }}
                        style={{
                          padding: "8px 14px", fontSize: "13.5px",
                          color: drawerPelanggan === opt ? "#4f66ee" : "#1e293b",
                          fontWeight: drawerPelanggan === opt ? 600 : 400,
                          backgroundColor: drawerPelanggan === opt ? "#f1f5f9" : "transparent",
                          cursor: "pointer",
                        }}
                      >
                        {opt}
              ...
              <div style={{ position: "relative" }} ref={drawerProdukRef}>
                ...
                >
                  <span style={{ fontSize: "13.5px", color: drawerProduk ? "#101828" : "#94a3b8" }}>
                    {drawerProduk || "Pilih produk"}
                  </span>
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#667085" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                    style={{ transition: "transform 0.2s ease", transform: showDrawerProdukDropdown ? "rotate(180deg)" : "rotate(0deg)" }}>
                    <path d="M6 9l6 6 6-6" />
                  </svg>
                </div>
                {showDrawerProdukDropdown && (
                  <div style={{
                    ...
                    {["Semua Produk", "Produk A", "Produk B", "Produk C"].map((opt) => (
                      <div
                        key={opt}
                        onClick={() => {
                          setDrawerProduk(opt);
                          setShowDrawerProdukDropdown(false);
                        }}
                        style={{
                          padding: "8px 14px", fontSize: "13.5px",
                          color: drawerProduk === opt ? "#4f66ee" : "#1e293b",
                          fontWeight: drawerProduk === opt ? 600 : 400,
                          backgroundColor: drawerProduk === opt ? "#f1f5f9" : "transparent",
                          cursor: "pointer",
                        }}
                      >
                        {opt}
              ...
              <div style={{ marginTop: "2px" }}>
                <label style={{ display: "flex", alignItems: "flex-start", gap: "10px", cursor: "pointer" }}>
                  <input
                    ...
                    style={{ marginTop: "3px", width: "16px", height: "16px", accentColor: "#4f66ee", cursor: "pointer" }}
                  />
                  <div>
                    <span style={{ fontSize: "13.5px", fontWeight: 600, color: "#344054" }}>
                      Lihat versi lebih detail
                    </span>
              ...
              <div style={{ position: "relative" }} ref={drawerUrutkanRef}>
                ...
                {showDrawerUrutkanDropdown && (
                  <div style={{
                    ...
                    {["Nama produk", "Kuantitas", "Penjualan bersih", "Pelanggan", "Tanggal", "Jumlah"].map((opt) => (
                      <div
                        key={opt}
                        onClick={() => {
